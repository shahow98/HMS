...
<body>
		<div id="result">
			...
			<table>
				...
				<tbody>
					<c:forEach var="collective" items="${requestScope.collectives }">
						<tr>
							<td>${collective.collective_name}</td>
							<td><a href="<%=basePath %>/servlet/householdmanage?func=searchCollectiveDetail&collective_name=${collective.collective_name}">详细信息</a></td>
